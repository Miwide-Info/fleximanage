...
const configEnv = {
  ...
  default: {
    ...
    tokenAllowedServers: process.env.TOKEN_ALLOWED_SERVERS || 'https://local.miwide.com:3443,http://local.miwide.com:3000,https://manage.miwide.com:443,https://manage.miwide.com:4443,https://manage.miwide.com,local.miwide.com:3443,manage.miwide.com:443,manage.miwide.com',
  ...
  captchaKey: process.env.CAPTCHA_SECRET_KEY || '',
    ...
    agentBroker: process.env.AGENT_BROKER ? process.env.AGENT_BROKER.split(',') : ['local.miwide.com:3443'],
    // Whitelist of allowed domains for CORS checks
    corsWhiteList: process.env.CORS_WHITELIST ? process.env.CORS_WHITELIST.split(',') : ['http://local.miwide.com:3000', 'https://local.miwide.com:3000', 'https://local.miwide.com:3443', 'https://127.0.0.1:3000', 'http://localhost:3000'],
